...
{
  lcd1602_i2c_sendCommand(LCD_FUNCTIONSET);
}
...
void lcd1602_i2c_cursorShow(bool state)
{
  if(state)
  {
    lcd1602_i2c_sendCommand(LCD_DISPLAYCONTROL | LCD_DISPLAY_B | LCD_DISPLAY_C | LCD_DISPLAY_D);
  }
  else
  {
    lcd1602_i2c_sendCommand(LCD_DISPLAYCONTROL | LCD_DISPLAY_D);
...
void lcd1602_i2c_display(bool state)
{
  ...
  {
    lcd1602_i2c_sendCommand(LCD_DISPLAYCONTROL | LCD_DISPLAY_B | LCD_DISPLAY_C);
  }
}
